...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f1f118bde44a6394fc119c589a3fc60) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-use-ocamlfind";
                      "-docflag -t -docflag 'API reference for utop' -docflags '-colorize-code -short-functors -charset utf-8 -css-style style.css'"
                   ];
                 run_path = "./"
              });
          ("utop-man",
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$gzip", ["-c"; "man/utop.1"; ">"; "man/utop.1.gz"]))
                   ];
                 cmd_clean =
                   [(OASISExpr.EBool true, Some (("$rm", ["man/utop.1.gz"])))
                   ];
            ...
            CustomPlugin.Doc.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$gzip",
                          ["-c"; "man/utop-full.1"; ">"; "man/utop-full.1.gz"
                          ]))
                   ];
                 cmd_clean =
                   [
                      (OASISExpr.EBool true,
                        Some (("$rm", ["man/utop-full.1.gz"])))
                   ];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("utoprc-man",
            CustomPlugin.Doc.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$gzip",
                          ["-c"; "man/utoprc.5"; ">"; "man/utoprc.5.gz"]))
                   ];
                 cmd_clean =
                   [
                      (OASISExpr.EBool true,
                        Some (("$rm", ["man/utoprc.5.gz"])))
                   ];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("utoprcs",
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/diml/utop";
          ...
          files_ab = ["src/lib/uTop_version.ml.ab"];
          sections =
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "camlp4 support";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "enable UTop_main.interact (requires ppx_tools)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["UTop_camlp4"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "utop";
                      lib_findlib_name = Some "camlp4";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("threads", None);
                           FindlibPackage ("findlib", None);
                           FindlibPackage ("lambda-term", None);
                           InternalLibrary "utop"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files =
                        [("utop.el", Some "$datadir/emacs/site-lisp")];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "uTop_top.ml"});
               Executable
                 ({
                     cs_name = "utop-full";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "uTop_top_full.ml"});
               Doc
                 ({
                     cs_name = "utop-api";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for utop";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("style.css", None)];
                      doc_build_tools =
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Man page for utop";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("man/utop.1.gz", None)];
                      doc_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "gzip"]
                   });
               Doc
                 ({
                     cs_name = "utop-full-man";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("man/utop-full.1.gz", None)];
                      doc_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "gzip"]
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$mandir/man5";
                      doc_title = "Man page for utoprc";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("man/utoprc.5.gz", None)];
                      doc_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "gzip"]
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "utoprc examples";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files =
                        [("utoprc-dark", None); ("utoprc-light", None)];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/diml/utop.git";
                      src_repo_browser = Some "https://github.com/diml/utop";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "A¥â¹±\005\135é«2CÛ¢\018Åv";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
